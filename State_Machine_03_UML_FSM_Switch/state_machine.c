...
{
   switch(myApp->active_state)
   {
      case IDLE:
      {
        return fsm_state_handler_IDLE(myApp, e);
      }

      case LED_SET:
      {
        return fsm_state_handler_LED_SET(myApp, e);
      }

      case BLINK:
      {
        return fsm_state_handler_BLINK(myApp, e);
      }

      case PAUSE:
      {
        return fsm_state_handler_PAUSE(myApp, e);
      }
   }
}
